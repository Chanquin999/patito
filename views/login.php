...
<head>
  ...
  <title>Cablenet Patito System</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">¡Bienvenido a Cablenet Patito!</h1>
              <p class="text-lead text-light">Para ingresar en el sistema debes acceder con tus credenciales. Si aun no tienes credenciales solicitalas al administrador del sistema.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          ...
          <div class="row mt-3">
            <div class="col-12">
              <a href="#" class="text-light"><small>¿Olvidaste tus datos?</small></a>
            </div>
          </div>
        </div>
      </div>
